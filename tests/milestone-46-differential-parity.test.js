...
test("provides a read-only in-game differential-parity QA route", async () => {
  ...
  assert.match(main, /\["parity", "differential-parity", "release-candidate", "fidelity", "animal-fidelity", "visual-regression", "reference-overlay", "scale-calibration"\]\.includes\(qaMode\)/);
