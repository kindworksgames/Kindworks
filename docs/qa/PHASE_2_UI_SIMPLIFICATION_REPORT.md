...
| House Rescue | `phase2-evidence/wave4-house-rescue/house-rescue-picker-568x320-before.png` | `phase2-ui-evidence/after/house-rescue-direct-568x320.png` | 568×320; 390×844 rotate state | 1024×768 | Direct entry without picker, correct organic sort reduced items 8→7, stable compact slots prevent tap overlap, orientation resumed exact rescue; 573/573 tests | Pending commit |
