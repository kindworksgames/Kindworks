const itemRows = [
  ...
  ["river-minnows", "River Minnows", "🐟", "consumable", 140, "Animal Treats", { retailer: "fresh-market" }],
  ["fresh-sardines", "Fresh Sardines", "🐟", "consumable", 220, "Animal Treats", { retailer: "fresh-market" }],
  ["river-trout", "River Trout", "🐟", "consumable", 360, "Animal Treats", { retailer: "fresh-market" }],
  ["pond-pellets", "Pond Pellets", "🫧", "consumable", 80, "Animal Treats", { retailer: "fresh-market" }],
  ["chicken-pieces", "Chicken Pieces", "🍗", "consumable", 180, "Animal Treats", { retailer: "fresh-market" }],
  ["beef-strips", "Beef Strips", "🥩", "consumable", 260, "Animal Treats", { retailer: "fresh-market" }],
  ["prepared-meat", "Prepared Meat Bites", "🍖", "consumable", 210, "Animal Treats", { retailer: "fresh-market" }],
